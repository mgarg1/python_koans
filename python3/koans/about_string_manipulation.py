...
class AboutStringManipulation(Koan):
    ...
    def test_use_format_to_interpolate_variables(self):
        value1 = 'one'
        value2 = 2
        string = "are {0} and {1}".format(value1, value2)
        self.assertEqual("are one and 2", string)

    def test_formatted_values_can_be_shown_in_any_order_or_be_repeated(self):
        value1 = 'd'
        value2 = 'D'
        string = "The values are {1}, {0}, {0} and {1}!".format(value1, value2)
        self.assertEqual("The values are D, d, d and D!", string)
    ...
    def test_strings_can_be_split_with_different_patterns(self):
        ...
        self.assertListEqual(["the","rain",";in,spain"_, __, __, __], words)
